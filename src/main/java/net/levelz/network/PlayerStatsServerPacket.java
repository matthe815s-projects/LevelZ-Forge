...
public class PlayerStatsServerPacket {
    ...
    public static void init() {
        ...
        LevelzClient.NETWORK.registerMessage(PacketServerSyncLevel.class, PacketServerSyncLevel.class, 4, Side.SERVER);
    }

    public static void writeS2CSyncLevelPacket(PlayerStatsManager playerStatsManager, EntityPlayerMP serverPlayerEntity, Skill skill) {
